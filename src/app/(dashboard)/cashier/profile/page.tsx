    ...
    <div>
      ...
      <div className="p-6 space-y-6">
        <PageHeader
          ...
          role="cashier"
          breadcrumbs={[{ label: "Cashier" }, { label: "My Profile" }]}
        />
        <div className="grid gap-6 lg:grid-cols-3">
          <Card className="flex flex-col items-center p-6 gap-4">
            <div className="flex h-24 w-24 items-center justify-center rounded-full bg-pink-100 text-pink-700 dark:bg-pink-900 dark:text-pink-300 text-3xl font-bold">
              {user.avatar}
            </div>
            <div className="text-center space-y-1">
              <p className="font-semibold text-gray-900 dark:text-gray-100">{user.name}</p>
              <p className="text-sm text-muted-foreground">{user.email}</p>
              <RoleBadge role="cashier" className="mt-1" />
            </div>
          ...
          <Card className="lg:col-span-2">
            ...
            <CardContent className="space-y-4">
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="space-y-2"><Label>Role</Label><Input defaultValue="Cashier" disabled className="opacity-60" /></div>
              </div>

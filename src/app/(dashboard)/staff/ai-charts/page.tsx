...
export default function StaffAIChartsPage() {
  return (
    <div>
      <Header />
      <div className="p-6 space-y-6">
        <PageHeader
          title="AI Charts"
          description="AI-powered analytics for your performance"
          role="staff"
          breadcrumbs={[{ label: "Staff" }, { label: "AI Charts" }]}
        />
              ...
              <CardContent>
                <div className="flex h-40 items-center justify-center rounded-lg bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-950/30 dark:to-purple-950/30 border border-dashed border-indigo-200 dark:border-indigo-800">
                  <div className="text-center space-y-1">
                    <BarChart3 className="h-8 w-8 text-indigo-300 dark:text-indigo-700 mx-auto" />
                    <p className="text-xs text-indigo-400 dark:text-indigo-500">AI Chart · Connect backend</p>
                  </div>
                </div>
              </CardContent>
            </Card>
